...
export class CartController {
    ...
    @ApiResponse({
        status: 400,
        description: 'Missing or invalid cart identity',
    })
    ...
    @ApiResponse({
        status: 200,
        description: 'Cart after adding item',
        type: Object,
    })
    @ApiResponse({ status: 404, description: 'Product or variant not found' })
    @ApiResponse({
        status: 409,
        description: 'Product unavailable or stock exceeded',
    })
    ...
    @ApiResponse({
        status: 200,
        description: 'Cart after updating item',
        type: Object,
    })
